            ...
            <tr>
                ...
                <td class="edit-delete">
                    <form method="post" action="client-delete.php">
                        <input class="test te1" onclick="window.location = 'client-edit.php?id=<?php echo $item['client_id']; ?>'" type="button" value="Sửa" />
                        <input type="hidden" name="id" value="<?php echo $item['client_id']; ?>" />
                        <input class="test te2" onclick="return confirm('Bạn có chắc muốn xóa không?');" type="submit" name="delete" value="Xóa" />
                    </form>
                </td>
