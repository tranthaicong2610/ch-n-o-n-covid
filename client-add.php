...
<head>
    <title>Thêm khách hàng  chẩn đoán </title>
    <meta charset="UTF-8">
...
<body>
    <h1>Thêm khách hàng  chẩn đoán  </h1>
    ...
    <form method="post" action="client-add.php">
        <table width="50%" border="1" cellspacing="0" cellpadding="10">
            <tr>
                <td>Tên </td>
                <td>
                    <input type="text" name="name" value="<?php echo !empty($data['client_name']) ? $data['client_name'] : ''; ?>" />
            ...
            <tr>
                ...
                <td>
                    <select name="sex">
                        ...
                        <option value="Nữ" <?php if (!empty($data['client_sex']) && $data['client_sex'] == 'Nữ') echo 'selected'; ?>>Nu</option>
                    </select>
            ...
            <tr>
                <td></td>
                <td>
                    <input class ="save" type="submit" name="add_client" value="Lưu" />
                </td>
            </tr>
        </table>
    </form>
